...
This section contains the rules for changing the Apache Arrow Flight client for Node.js.
...
- Arrow Flight and Arrow IPC compatibility;
...
- when the public API, gRPC behavior, build pipeline, generated bindings, or publish output changes.
