...
- public package surface and curated low-level protocol namespace:
  [`src/index.ts`](https://github.com/woodger/arrow-flight-client/blob/0.0.16/src/index.ts)
  and
  [`src/flight-protocol.ts`](https://github.com/woodger/arrow-flight-client/blob/0.0.16/src/flight-protocol.ts);
- client behavior:
  [`src/client/`](https://github.com/woodger/arrow-flight-client/tree/0.0.16/src/client);
- Flight wire contract: [`contracts/Flight.proto`](../../contracts/Flight.proto);
- generated TypeScript bindings:
  [`src/generated/Flight.ts`](https://github.com/woodger/arrow-flight-client/blob/0.0.16/src/generated/Flight.ts);
- compiler settings:
  [`tsconfig.json`](https://github.com/woodger/arrow-flight-client/blob/0.0.16/tsconfig.json);
- lint configuration:
