  ...
  fromJSON(object: any): FlightInfo {
    return {
      ...
      flightDescriptor: isSet(object.flightDescriptor)
        ...
        : isSet(object.flight_descriptor)
        ? FlightDescriptor.fromJSON(object.flight_descriptor)
        : undefined,
      ...
      totalRecords: isSet(object.totalRecords)
        ? globalThis.Number(object.totalRecords)
        : isSet(object.total_records)
        ? globalThis.Number(object.total_records)
        : 0,
      ...
      appMetadata: isSet(object.appMetadata)
        ...
        : isSet(object.app_metadata)
        ? Buffer.from(bytesFromBase64(object.app_metadata))
        : Buffer.alloc(0),
    };
  },
  ...
  fromJSON(object: any): FlightData {
    return {
      ...
      dataHeader: isSet(object.dataHeader)
        ...
        : isSet(object.data_header)
        ? Buffer.from(bytesFromBase64(object.data_header))
        : Buffer.alloc(0),
      appMetadata: isSet(object.appMetadata)
        ? Buffer.from(bytesFromBase64(object.appMetadata))
        : isSet(object.app_metadata)
      ...
      dataBody: isSet(object.dataBody)
        ...
        : isSet(object.data_body)
        ? Buffer.from(bytesFromBase64(object.data_body))
        : Buffer.alloc(0),
    };
  },
  ...
  fromJSON(object: any): SessionOptionValue {
    return {
      ...
      stringListValue: isSet(object.stringListValue)
        ...
        : isSet(object.string_list_value)
        ? SessionOptionValue_StringListValue.fromJSON(object.string_list_value)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): SetSessionOptionsRequest {
    return {
      sessionOptions: isObject(object.sessionOptions)
        ? (globalThis.Object.entries(object.sessionOptions) as [string, any][]).reduce(
          (acc: { [key: string]: SessionOptionValue }, [key, value]: [string, any]) => {
            globalThis.Object.defineProperty(acc, key, {
              value: SessionOptionValue.fromJSON(value),
              enumerable: true,
              configurable: true,
              writable: true,
            });
        ...
        : isObject(object.session_options)
        ? (globalThis.Object.entries(object.session_options) as [string, any][]).reduce(
          (acc: { [key: string]: SessionOptionValue }, [key, value]: [string, any]) => {
            globalThis.Object.defineProperty(acc, key, {
              value: SessionOptionValue.fromJSON(value),
              enumerable: true,
      ...
      errors: isObject(object.errors)
        ? (globalThis.Object.entries(object.errors) as [string, any][]).reduce(
          (acc: { [key: string]: SetSessionOptionsResult_Error }, [key, value]: [string, any]) => {
            globalThis.Object.defineProperty(acc, key, {
              value: SetSessionOptionsResult_Error.fromJSON(value),
              enumerable: true,
              configurable: true,
              writable: true,
            });
...
export const FlightServiceDefinition = {
  ...
  methods: {
    ...
    handshake: {
      name: "Handshake",
      requestType: HandshakeRequest as typeof HandshakeRequest,
      requestStream: true,
      responseType: HandshakeResponse as typeof HandshakeResponse,
      responseStream: true,
      options: {},
    },
    /**
    ...
    listFlights: {
      name: "ListFlights",
      requestType: Criteria as typeof Criteria,
      requestStream: false,
      responseType: FlightInfo as typeof FlightInfo,
      responseStream: true,
      options: {},
    },
    /**
    ...
    getFlightInfo: {
      name: "GetFlightInfo",
      requestType: FlightDescriptor as typeof FlightDescriptor,
      requestStream: false,
      responseType: FlightInfo as typeof FlightInfo,
    ...
    pollFlightInfo: {
      ...
      requestType: FlightDescriptor as typeof FlightDescriptor,
      requestStream: false,
      responseType: PollInfo as typeof PollInfo,
      responseStream: false,
      options: {},
    },
    /**
    ...
    getSchema: {
      ...
      requestType: FlightDescriptor as typeof FlightDescriptor,
      requestStream: false,
      responseType: SchemaResult as typeof SchemaResult,
      responseStream: false,
      options: {},
    },
    /**
    ...
    doGet: {
      name: "DoGet",
      requestType: Ticket as typeof Ticket,
      requestStream: false,
      responseType: FlightData as typeof FlightData,
      responseStream: true,
      options: {},
    },
    /**
    ...
    doPut: {
      name: "DoPut",
      requestType: FlightData as typeof FlightData,
      requestStream: true,
      responseType: PutResult as typeof PutResult,
      responseStream: true,
      options: {},
    },
    /**
    ...
    doAction: {
      name: "DoAction",
      requestType: Action as typeof Action,
      requestStream: false,
      responseType: Result as typeof Result,
      responseStream: true,
      options: {},
    },
    /**
    ...
    listActions: {
      ...
      requestStream: false,
      responseType: ActionType as typeof ActionType,
      responseStream: true,
      options: {},
    },
  },
